...
export type ServiceWorkerToastProps =
  | NeedRefreshToastProps
  | OfflineReadyToastProps;

const isNeedRefreshToast = (props: any): props is NeedRefreshToastProps =>
  props.variant === "needRefresh";
